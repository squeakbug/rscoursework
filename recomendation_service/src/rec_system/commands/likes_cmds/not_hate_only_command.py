...
class NotHateOnlyCommandContructor(ICommandConstructor):
    user_repo = None
    pics_repo = None
    ...
    def construct(self, cmd_reg_res: CommandRecognizerResult) -> RecSystemCommandBase:
        ...
        return NotHateOnlyCommand(self.user_repo, self.pics_repo, picture_name)


class NotHateOnlyCommandResponse(ICommandResponse):
    output_picture = None
...
class NotHateOnlyCommand(RecSystemCommandBase):
    picture_name = None
    ...
    def execute(self) -> ICommandResponse:
        ...
        return NotHateOnlyCommandResponse(selected_pic)

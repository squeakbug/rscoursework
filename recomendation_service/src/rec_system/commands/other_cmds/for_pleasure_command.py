...
class ForPleasureCommandContructor(ICommandConstructor):
    def construct(self, _: CommandRecognizerResult) -> RecSystemCommandBase:
        return ForPleasureCommand()


class ForPleasureCommandResponse(ICommandResponse):
...
class ForPleasureCommand(RecSystemCommandBase):
    def __init__(self) -> None:
        super().__init__()
    ...
    def execute(self) -> ICommandResponse:
        return ForPleasureCommandResponse()
